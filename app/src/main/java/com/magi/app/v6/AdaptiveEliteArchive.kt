...
internal class AdaptiveEliteArchive(
    ...
    companion object {
        ...
        // [3.352.0] 3キーを写さず MirrorCore.reportComparator へ委譲（旧: 同じ順序を手で複製していた）。
        internal fun compareReports(a: ViolationReport, b: ViolationReport): Int =
            reportComparator.compare(a, b)
